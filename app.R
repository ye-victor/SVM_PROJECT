...
roc(svm.predict,as.numeric(test$Class),plot=T,main="SVM with radial kernel",legacy.axes=TRUE,percent=TRUE,xlab="False Positive Percentage",ylab="True Positive Percentage",col="#377eb8",lwd=4,print.auc=T,print.auc.y=30, print.auc.x=25)
  ...
  if (x()=="Linear"){
    ...
    svm.predict <- predict(svm.model,test)
    roc(svm.predict,as.numeric(test$Class),plot=T,main="SVM with linear kernel",legacy.axes=TRUE,percent=TRUE,xlab="False Positive Percentage",ylab="True Positive Percentage",col="#377eb8",lwd=4,print.auc=T,print.auc.y=30, print.auc.x=25)
  }
  if (x()=="Polynomial"){
    withProgress(message = 'Calcul with new values in progress...', value = 0,style = getShinyOption("progress.style",
                                                                                             default = "old"),{
    ...
    svm.predict <- predict(svm.model,test)
    roc(svm.predict,as.numeric(test$Class),plot=T,main="SVM with polynomial kernel",legacy.axes=TRUE,percent=TRUE,xlab="False Positive Percentage",ylab="True Positive Percentage",col="#377eb8",lwd=4,print.auc=T,print.auc.y=30, print.auc.x=25)
   }
  if (x()=="Sigmoid"){
    withProgress(message = 'Calcul with new values in progress...',value = 0,style = getShinyOption("progress.style",
                                                                                               default = "old"), {
    ...
    svm.predict <- predict(svm.model,test)
    roc(svm.predict,as.numeric(test$Class),plot=T,main="SVM with sigmoid kernel",legacy.axes=TRUE,percent=TRUE,xlab="False Positive Percentage",ylab="True Positive Percentage",col="#377eb8",lwd=4,print.auc=T,print.auc.y=30, print.auc.x=25)
  }
})  
