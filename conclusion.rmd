...
Contrairement aux arbres de décision, un vecteur de support n'est pas quelque chose que la plupart des gens peuvent visualiser. Le coût en temps de calcul est plus élevé en temps de calcul que les autres méthodes.

<p>Comme il s'agit d'un cas de détection de fraude, il est plus plausible d'utiliser *la fonction de perte* pour sélectionner notre modèle.</p>  
