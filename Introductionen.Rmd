...
<strong>Correction and processing done</strong> : We splited the database into a training sample and a test sample, 70% and 30% respectively. Subsequently, we used the SMOTE (Synthetic Minority Oversampling Technique) method on the training sample. [(more details)](http://rikunert.com/SMOTE_explained?fbclid=IwAR08i0mcS_fg6G_IEmtq2fjIjSg5PI1ESiLPrOZp3eoNkK2yKYLUKGZOCcA).
<p></p>
