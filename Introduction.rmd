...
<strong>Correction et traitements apportés</strong> : Nous avons séparés la base de donnée en un échantillon d'apprentissage et un échantillon test, à hauteur respectivement de 70 % et 30 %. Par la suite, nous avons utilisé la méthode SMOTE (Synthetic Minority Oversampling Technique) sur l'échantillon d'apprentissage. [(plus de détails)](http://rikunert.com/SMOTE_explained?fbclid=IwAR08i0mcS_fg6G_IEmtq2fjIjSg5PI1ESiLPrOZp3eoNkK2yKYLUKGZOCcA).
<p></p>
